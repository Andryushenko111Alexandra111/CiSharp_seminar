...
// int userArrayStart = TakeEntNum("Введите первое число массива:");
// int userArrayEnd = TakeEntNum("Введите последнее число массива:");
// int userSearchNumber = TakeEntNum("Укажите число для поиска в массиве: ");
