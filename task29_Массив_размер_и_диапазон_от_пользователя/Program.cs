/*
Напишите программу, которая выведет в консоль массив. 
Размер и диапозон взять у пользователя
...
void PrintArray(int[] arr)
{
    ...
    for (int i = 0; i < arr.Length; i++)
    {
        ...
        Thread.Sleep(100); // пауза при выведении цифр 
        if (i < arr.Length - 1)
        System.Console.Write(", ");//[5, 7, 1, 4]
    }
    System.Console.Write("]");
    Console.ResetColor(); //возврат цвета
}
